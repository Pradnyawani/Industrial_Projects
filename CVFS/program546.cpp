...
void DisplayHelp()
{
    ...
    printf("cls   : It is use to clear the treminal\n");
    printf("creat : It is use to create new file\n");  
    printf("write : It is use toerite the data into the file\n"); 
    printf("read  : It is use to read the data from file\n"); 
    printf("stat  : It is use to display statistial information\n"); 
    printf("unlink: It is use to display delete the file\n"); 
    printf("exit  : It is use to teminate marvellous cvfs\n"); 
...
void ManPageDisplay(char Name[])
{
    ...
    {
        printf("No manual entry for demo");
    }
}
///////////////////////////////////////////////////////////////////////////////////
//
